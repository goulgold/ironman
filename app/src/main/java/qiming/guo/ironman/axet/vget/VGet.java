package qiming.guo.ironman.axet.vget;
...
import qiming.guo.ironman.axet.vget.info.VGetParser;
import qiming.guo.ironman.axet.vget.info.VideoInfo;
import qiming.guo.ironman.axet.vget.info.VideoInfo.States;
import qiming.guo.ironman.axet.vget.vhs.VimeoParser;
import qiming.guo.ironman.axet.vget.vhs.YouTubeParser;
import qiming.guo.ironman.axet.wget.Direct;
import qiming.guo.ironman.axet.wget.DirectMultipart;
import qiming.guo.ironman.axet.wget.DirectRange;
import qiming.guo.ironman.axet.wget.DirectSingle;
import qiming.guo.ironman.axet.wget.RetryWrap;
import qiming.guo.ironman.axet.wget.info.DownloadInfo;
import qiming.guo.ironman.axet.wget.info.DownloadInfo.Part;
import qiming.guo.ironman.axet.wget.info.ex.DownloadError;
import qiming.guo.ironman.axet.wget.info.ex.DownloadIOCodeError;
import qiming.guo.ironman.axet.wget.info.ex.DownloadIOError;
import qiming.guo.ironman.axet.wget.info.ex.DownloadInterruptedError;
import qiming.guo.ironman.axet.wget.info.ex.DownloadMultipartError;
import qiming.guo.ironman.axet.wget.info.ex.DownloadRetry;
...
//            String sfilename = replaceBadChars(info.getTitle());
            String sfilename = replaceBadChars(info.getVideoID());
...
/*            do {
            ...
            f = new File(targetDir, sfilename + "." + ext);
...
//                            targetFile = null;
                    ...
                    // IF the file exists, do not download and return directly.
                    if (targetFile.exists()) {
                        info.setState(States.EXIST);
                        return;
                    }
